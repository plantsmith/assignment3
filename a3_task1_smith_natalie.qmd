...
# Overview: 
describe the data
question(s) to be addressed in your analysis
...
# Exploratory Plots:
Add a sentence or two with a takeaway from the plots:
based on these plots, which predictor variables are more likely to help classify species correctly?
