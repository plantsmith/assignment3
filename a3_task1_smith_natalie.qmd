...
We aim to create two predictive models with different predictor variable to determine which variables are better at predicting the plant species. Two models with different predictor variables will be created, and the better-performing model will be selected. We will then evaluate the success of the chosen model in correctly classifying a plant species.

::: image-grid
![Left: Sabal etonia, Right: Serenoa repens](misc/palms.jpg)
:::
...
save_kable(species_correct_kable, file = "plots/species_correct_kable.html")
