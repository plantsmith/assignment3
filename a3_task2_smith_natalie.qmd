...
The dataset we will be using contains crop data with the following variables:
...
hi_plot <- un_df %>%
  ...
  geom_line(aes(x = doy, y = smooth, linetype = crop)) +labs(y = "Biomass (Mg/ha)", x = "Day of Year", color = " ")+
  theme_minimal()
